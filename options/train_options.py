...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--val_freq', type=int, default=1, help='Validation frequency w.r.t epochs')
        parser.add_argument('--cutout_size', type=int, default=0, help='Erase patch of given size')
